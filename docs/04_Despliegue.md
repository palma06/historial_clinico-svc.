# Historial Clínico — Despliegue y operación
...
| API base | `/api/expedientes` |

## Docker

```bash
docker build -t duoc/caso07-historial-clinico:1.0.0 .
docker run -p 8080:8080 duoc/caso07-historial-clinico:1.0.0
```
